...
const navigation = [
  ...
  {
    title: 'Bladework faults',
    links: [
      {
        title: 'Timing late at the catch',
        href: '/docs/timing-late-at-the-catch',
      },
      {
        title: 'Skying at the catch',
        href: '/docs/skying-at-the-catch',
      },
      { title: 'Looming', href: '/docs/looming' },
      {
        title: 'Backsplash',
        href: '/docs/backsplash',
      },
      { title: 'The short stroke', href: '/docs/the-short-stroke' },
      { title: 'The two-part stroke', href: '/docs/the-two-part-stroke' },
      { title: 'Washing out', href: '/docs/washing-out' },
      {
        title: 'Dirty finishes including catching a crab',
        href: '/docs/dirty-finishes-including-catching-a-crab',
      },
      {
        title: 'Blade clipping the water during the recovery`',
        href: '/docs/blade-clipping-the-water-during-the-recovery',
      },
    ],
  },
  {
    title: 'Body position faults',
    links: [
      {
